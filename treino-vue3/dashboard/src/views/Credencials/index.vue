<template>
  ...
  <div class="flex justify-center w-full h-full">
    <div class="flex flex-col w-4/5 max-w-6xl py-10">
      ...
      <content-loader v-if="store.Global.isLoading || state.isLoading" class="rounded" width="600px" height="500px"/>
      <div v-else class="flex py-3 pl-5 pr-20 mt-2 rounded items-center bg-brand-gray w-full lg:w-1/2">
      ...
      <div v-else class="py-3 pl-5 pr-20 mt-2 rounded bg-brand-gray w-full lg:w-2/3 overflow-x-scroll">
        ...
        <pre v-else>&lt;script src="https://felipebetini-feedbacker-widget.netlify.app?api_key={{store.User.currentUser.apiKey}}"&gt;&lt;/script&gt;</pre>
      </div>
    </div>
  </div>
</template>
