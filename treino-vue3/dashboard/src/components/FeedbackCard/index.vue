<template>
  <div
    @click="handleToggle"
    class="flex-col px-8 py-6 rounded cursor-pointer bg-brand-gray"
    >
  ...
  <div
  :class="{
    animated__fadeOutUp:  state.isClosing
  }"
  class="flex mt-8 animate__animated animated__fadeInUp animate__faster"
  v-if="state.isOpen"
  >
    <div class="flex flex-col w-1/2">
      <div class="flex flex-col">
        <span class="font-bold text-gray-400 uppercase select-none">Pagina</span>
